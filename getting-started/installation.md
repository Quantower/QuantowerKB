...
{% hint style="info" %}
* Windows 10, 11
* [.NET 8.](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-8.0.15-windows-x64-installer) In most cases, the platform will ask to update .NET to the latest version from the Microsoft official website.
