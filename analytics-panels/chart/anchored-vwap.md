...
* **Left Range** — defines the starting point for custom VWAP<br>
*   **Mode** — there are 2 modes — **Anchored, and Custom** — that control the right range of the VWAP:\
    ...
    &#x20;  **Custom mode** fixes both borders of the range for the VWAP calculation.<br>
...
* **Data type** — set the data for VWAP calculation: **Ticks** or **Current TF.**\
  ...
  &#x20;  **Current TF** will use Bar data from the current selected Timeframe of your chart. It will use Price type data and multiply it by Bar Volume.<br>
