---
description: >-
  Add the Aroon indicator in Quantower to measure trend strength and timing and
  detect the start of new trends across markets
---
...
**AroonUp** measures how long it has been since prices have recorded a **new high** within the specified period. If the current bar’s high is the highest within the user-defined period.
