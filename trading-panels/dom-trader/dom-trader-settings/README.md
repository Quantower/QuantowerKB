---
description: >-
  Customize the DOM Trader in Quantower — open the settings menu to adjust the
  layout, columns, and display for a faster trading workflow
---
...
**1)** To open DOM Trader settings, click on the '<mark style="background-color:blue;">**Menu**</mark>**'** button in the upper-left corner and select the <mark style="background-color:blue;">**Settings**</mark> item.
...
The general view of the DOM Trader settings menu has the following subsections. Let's take a closer look at them:
